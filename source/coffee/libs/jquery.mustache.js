/*
 * NOTES:
 * - The internationalization global _() was replaced by t() because we're using underscore.js
 * - This patch was added: github.com/janl/mustache.js/commit/bf95689f4282d0a60162e8e093933c8cd07c73f1
 */
    ...
    */
    ...
    render_i18n: function(html, context, partials) {
      ...
      return html.replace(regex, function(match, content) {
        ...
        return that.render(t(content, translation_mode), context, partials, true);
      });
    },
